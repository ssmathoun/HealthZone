    ...
    fetch(
      ...
      .then((data) => {
        if (data.status === "success" && Array.isArray(data.logs)) {
          setCompletedWorkouts(data.logs);
        }
      })
      .catch(() => {})
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-[#1e293b]">
                    {historyLoading ? "—" : totalMinutes.toLocaleString()}
                  </p>
            ...
            <div className="bg-white rounded-lg shadow-md p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xl font-bold text-[#1e293b]">
                    {historyLoading ? "—" : totalCalories.toLocaleString()}
                  </p>
                  ...
                  <div key={w.id} className="bg-white rounded-lg shadow-md p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-xs text-[#64748b] font-medium">
                        {formatWorkoutDate(w.completed_at)}
                      </span>
                    </div>
                    <div className="flex items-center gap-4 text-xs text-[#64748b]">
                      <span className="flex items-center gap-1">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded text-xs font-medium ${w.difficulty === "Beginner-Friendly" ? "bg-green-100 text-green-700" : "bg-[#d97706]/10 text-[#d97706]"}`}
                      >
                        {w.difficulty}
                      </span>
                    </div>
