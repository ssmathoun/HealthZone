      ...
      <main className="px-4 py-4 max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <StatCard
            ...
            percentage={Math.round((stats.caloriesConsumed / stats.caloriesGoal) * 100)}
          />
          <StatCard
            ...
            percentage={Math.round((stats.proteinsConsumed / stats.proteinsGoal) * 100)}
          />
          <button
        ...
        {/* Active Challenges */}
        <div className="bg-gradient-to-br from-[#1e293b] to-[#334155] rounded-lg shadow-md p-4 mb-4 text-white">
