    ...
    return (
        <div className="mobile-profile-container">
            <header className="mobile-header">
                <button className="back-btn" onClick={() => window.location.href='https://aptitude.cse.buffalo.edu/CSE442/2026-Spring/cse-442v/healthzone/'}>←</button>
                <h1>Edit Profile</h1>
            ...
            <form onSubmit={handleSave} className="mobile-form">
                ...
                <button 
                    ...
                    onClick={() => window.location.href='https://aptitude.cse.buffalo.edu/CSE442/2026-Spring/cse-442v/healthzone/'}
                >
                    Home
                </button>
            </form>
