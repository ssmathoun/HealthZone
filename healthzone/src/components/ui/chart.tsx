...
// Explicitly define the props to bypass Recharts type conflicts
interface ChartTooltipContentProps extends Omit<React.ComponentProps<"div">, "content" | "payload"> {
  active?: boolean;
  payload?: any[];
              ...
              {formatter && item?.value !== undefined && item.name ? (
                ...
                <>
                  {itemConfig?.icon ? (
                    ...
                    !hideIndicator && (
                      <div
                        className={cn("shrink-0 rounded-[2px] border-transparent bg-[var(--color-bg)]", {
                            "h-2.5 w-2.5": indicator === "dot",
                            "w-1": indicator === "line",
                            "w-0 border-[1.5px] border-dashed bg-transparent border-[var(--color-border)]": indicator === "dashed",
...
// Explicitly define the props to bypass Recharts type conflicts
interface ChartLegendContentProps extends Omit<React.ComponentProps<"div">, "payload" | "content"> {
  payload?: any[];
