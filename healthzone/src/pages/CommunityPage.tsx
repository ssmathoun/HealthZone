  ...
  const fetchPosts = () => {
    ...
    fetch(`${API_BASE}/forum.php?action=get_posts`, { credentials: "include" })
      ...
      .catch(() => {
        ...
        fetch(`${API_BASE}/posts.php?action=get_posts`, {
          credentials: "include",
        })
          .then((res) => res.json())
          .then((data) => {
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              ...
              className="bg-[#d97706] text-white px-4 py-2.5 rounded-lg hover:bg-[#b45309] font-medium text-sm flex items-center gap-2"
            >
                                      ...
                                      <div className="flex items-center gap-2 mb-0.5">
                                        ...
                                        {c.can_delete && (
                                          <button
                                            ...
                                            className="ml-auto opacity-0 group-hover:opacity-100 p-0.5 text-[#64748b] hover:text-red-500 transition-all disabled:opacity-40"
